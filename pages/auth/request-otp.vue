<template>
   <div class="w-100 flex flex-column fade-animation-1s">
        <div class="w-100 flex flex-column justify-start">
            ...
            <span class="f-s-12 f-w-100 color-primary pt-5">Request for otp code</span>
            </div>
            <BaseInput 
                validate="true" 
            ...
            />
            <BaseButton class="mt-15" name="Send" width="100%" height="40px" :loading="loading" :disabled="disabled" @click="sendPhone" />
   </div>
</template>
