declare global {
  ...
  const useCustomServerRequest: typeof import('../../server/utils/useCustomServerRequest')['useCustomServerRequest']
...
export { useCustomServerRequest } from '../../server/utils/useCustomServerRequest';